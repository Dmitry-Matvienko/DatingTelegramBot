...
public class LocalizationServiceTests
{
    ...
    [InlineData(AppLanguage.Russian, "City_SuggestionsPrompt")]
    [InlineData(AppLanguage.Ukrainian, "City_SuggestionsPrompt")]
    [InlineData(AppLanguage.English, "City_SuggestionsPrompt")]
    [InlineData(AppLanguage.Hindi, "City_SuggestionsPrompt")]
    [InlineData(AppLanguage.Portuguese, "City_SuggestionsPrompt")]
    [InlineData(AppLanguage.Indonesian, "City_SuggestionsPrompt")]
    [InlineData(AppLanguage.Russian, "City_NotFound_Or_Suggestions_Notice")]
    [InlineData(AppLanguage.Ukrainian, "City_NotFound_Or_Suggestions_Notice")]
    [InlineData(AppLanguage.English, "City_NotFound_Or_Suggestions_Notice")]
    [InlineData(AppLanguage.Hindi, "City_NotFound_Or_Suggestions_Notice")]
    [InlineData(AppLanguage.Portuguese, "City_NotFound_Or_Suggestions_Notice")]
    [InlineData(AppLanguage.Indonesian, "City_NotFound_Or_Suggestions_Notice")]
    [InlineData(AppLanguage.Russian, "Btn_SendLocation")]
    [InlineData(AppLanguage.Ukrainian, "Btn_SendLocation")]
    [InlineData(AppLanguage.English, "Btn_SendLocation")]
    [InlineData(AppLanguage.Hindi, "Btn_SendLocation")]
    [InlineData(AppLanguage.Portuguese, "Btn_SendLocation")]
    [InlineData(AppLanguage.Indonesian, "Btn_SendLocation")]
    [InlineData(AppLanguage.Russian, "Error_CityNotFound")]
    [InlineData(AppLanguage.Ukrainian, "Error_CityNotFound")]
    [InlineData(AppLanguage.English, "Error_CityNotFound")]
    [InlineData(AppLanguage.Hindi, "Error_CityNotFound")]
    [InlineData(AppLanguage.Portuguese, "Error_CityNotFound")]
    [InlineData(AppLanguage.Indonesian, "Error_CityNotFound")]
    [InlineData(AppLanguage.Russian, "Error_GeocodingFailed")]
    [InlineData(AppLanguage.Ukrainian, "Error_GeocodingFailed")]
    [InlineData(AppLanguage.English, "Error_GeocodingFailed")]
    [InlineData(AppLanguage.Hindi, "Error_GeocodingFailed")]
    [InlineData(AppLanguage.Portuguese, "Error_GeocodingFailed")]
    [InlineData(AppLanguage.Indonesian, "Error_GeocodingFailed")]
    [InlineData(AppLanguage.Russian, "City_DetectedFromLocation")]
    [InlineData(AppLanguage.Ukrainian, "City_DetectedFromLocation")]
    [InlineData(AppLanguage.English, "City_DetectedFromLocation")]
    [InlineData(AppLanguage.Hindi, "City_DetectedFromLocation")]
    [InlineData(AppLanguage.Portuguese, "City_DetectedFromLocation")]
    [InlineData(AppLanguage.Indonesian, "City_DetectedFromLocation")]
