...
public class LocalizationService : ILocalizationService
{
    private static readonly Dictionary<string, Dictionary<AppLanguage, string>> Strings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Menu_Guide"] = new()
        {
            [AppLanguage.Russian] = "📖 Руководство бота",
            [AppLanguage.Ukrainian] = "📖 Керівництво бота",
            [AppLanguage.English] = "📖 Bot Guide",
            [AppLanguage.Hindi] = "📖 बॉट गाइड",
        ...
        {
            [AppLanguage.Russian] = "🏠 <b>Главное меню DatingBot</b>\n\nИспользуйте кнопки внизу для навигации:\n• 👤 <b>Мой профиль</b> — просмотр и редактирование своей анкеты, фото, интересов и настроек\n• 🔍 <b>Искать анкеты</b> — поиск людей по вашим критериям и оценка анкет\n• 📖 <b>Руководство бота</b> — принцип работы, поиск, система оценок и подсказки",
            [AppLanguage.Ukrainian] = "🏠 <b>Головне меню DatingBot</b>\n\nВикористовуйте кнопки внизу для навігації:\n• 👤 <b>Мій профіль</b> — перегляд та редагування своєї анкети, фото, інтересів і налаштувань\n• 🔍 <b>Шукати анкети</b> — пошук людей за вашими критеріями та оцінка анкет\n• 📖 <b>Керівництво бота</b> — принцип роботи, пошук, система оцінок та підказки",
            [AppLanguage.English] = "🏠 <b>DatingBot Main Menu</b>\n\nUse the buttons below to navigate:\n• 👤 <b>My Profile</b> — view and edit your profile, photo, interests, and preferences\n• 🔍 <b>Search profiles</b> — discover people matching your criteria and rate profiles\n• 📖 <b>Bot Guide</b> — how the bot works, search features, rating system, and tips",
            [AppLanguage.Hindi] = "🏠 <b>DatingBot मुख्य मेनू</b>\n\nनेविगेट करने के लिए नीचे दिए गए बटनों का उपयोग करें:\n• 👤 <b>मेरी प्रोफाइल</b> — अपनी प्रोफाइल, फोटो, रुचियां और सेटिंग्स देखें और संपादित करें\n• 🔍 <b>प्रोफाइल खोजें</b> — अपनी प्राथमिकताओं के अनुसार लोगों को खोजें और रेट करें\n• 📖 <b>बॉट गाइड</b> — बॉट कैसे काम करता है, खोज, रेटिंग प्रणाली और सुझाव",
            [AppLanguage.Portuguese] = "🏠 <b>Menu Principal DatingBot</b>\n\nUse os botões abaixo para navegar:\n• 👤 <b>Meu Perfil</b> — visualize e edite seu perfil, foto, interesses e preferências\n• 🔍 <b>Procurar perfis</b> — descubra pessoas que combinam com você e avalie perfis\n• 📖 <b>Guia do Bot</b> — como o bot funciona, busca, sistema de avaliação e dicas",
            [AppLanguage.Indonesian] = "🏠 <b>Menu Utama DatingBot</b>\n\nGunakan tombol di bawah untuk navigasi:\n• 👤 <b>Profil Saya</b> — lihat dan edit profil, foto, minat, dan preferensi Anda\n• 🔍 <b>Cari profil</b> — temukan orang yang cocok dengan kriteria Anda dan beri penilaian\n• 📖 <b>Panduan Bot</b> — cara kerja bot, pencarian, систем penilaian, dan tips"
        },
        ["BotGuide_Text"] = new()
        {
            [AppLanguage.Russian] = "📖 <b>Руководство пользователя DatingBot</b>\n\nДобро пожаловать! Бот помогает легко находить интересные знакомства на основе взаимной симпатии, общих интересов и умного AI-подбора.\n\n🔍 <b>Как устроен поиск и подбор:</b>\n• <b>Умный алгоритм:</b> подбирает людей на основе вашего описания для ИИ, по вашему городу, возрасту, целям знакомства и совместимости интересов.\n• <b>Дальность поиска:</b> в профиле вы можете настроить радиус — до 100 км, до 500 км, по всей стране или без ограничений.\n• <b>Бесконечный поиск:</b> анкеты не заканчиваются — когда просмотрены все новые, поиск начнется заново по кругу.\n\n⭐ <b>Система оценок (1–10):</b>\nОценивайте пользователей и получайте взаимные симпатии.\n• <b>1–5</b> — идёт в общую копилку среднего балла.\n• <b>6–10</b> — выразить симпатию. Человек получит уведомление с вашей оценкой и сможет оценить вас в ответ.\n• <b>Взаимная симпатия:</b> если вы оба поставили друг другу 6+, открывается кнопка <b>«💬 Написать»</b> для прямого перехода в личные сообщения.\n\n👤 <b>Ваш профиль и настройки:</b>\n• В разделе <b>«👤 Мой профиль»</b> можно в любой момент обновить фото, имя, город, интересы, цели, фильтры поиска и т.д.\n• <b>AI-описание:</b> приватный текст о себе — его никто не видит, но искусственный интеллект учитывает его при поиске идеальных совпадений.\n\n🛡 <b>Безопасность и правила:</b>\n• Если вы столкнулись со спамом, фейком (человек, которого вы знаете, но это не он) или оскорблениями — нажмите <b>«🚨 Пожаловаться»</b> при просмотре анкеты.\n• Официальный канал: @TheBestDating\n• Поддержка: @KimeLowe65",
            [AppLanguage.Ukrainian] = "📖 <b>Керівництво користувача DatingBot</b>\n\nЛаскаво просимо! Бот допомагає легко знаходити цікаві знайомства на основі взаємної симпатії, спільних інтересів та розумного AI-підбору.\n\n🔍 <b>Як влаштований пошук та підбір:</b>\n• <b>Розумний алгоритм:</b> підбирає людей на основі вашого опису для ШІ, за вашим містом, віком, цілями знайомства та сумісністю інтересів.\n• <b>Дальність пошуку:</b> у профілі ви можете налаштувати радіус — до 100 км, до 500 км, по всій країні або без обмежень.\n• <b>Нескінченний пошук:</b> анкети не закінчуються — коли переглянуто всі нові, пошук почнеться знову по колу.\n\n⭐ <b>Система оценок (1–10):</b>\nОцінюйте користувачів та отримуйте взаємні симпатії.\n• <b>1–5</b> — йде в загальну скарбничку середнього бала.\n• <b>6–10</b> — виявити симпатію. Людина отримає сповіщення з вашою оцінкою та зможе оцінити вас у відповідь.\n• <b>Взаємна симпатія:</b> якщо ви обидва поставили один одному 6+, відкривається кнопка <b>«💬 Написати»</b> для прямого переходу в особисті повідомлення.\n\n👤 <b>Ваш профіль і налаштування:</b>\n• У розділі <b>«👤 Мій профіль»</b> можна будь-коли оновити фото, ім'я, місто, інтереси, цілі, фільтри пошуку тощо.\n• <b>AI-опис:</b> приватний текст про себе — його ніхто не бачить, але штучний інтелект враховує його під час пошуку ідеальних збігів.\n\n🛡 <b>Безпека та правила:</b>\n• Якщо ви натрапили на спам, фейк (людина, яку ви знаєте, але це не вона) чи образи — натисніть <b>«🚨 Поскаржитися»</b> під час перегляду анкети.\n• Офіційний канал: @TheBestDating\n• Підтримка: @KimeLowe65",
            [AppLanguage.English] = "📖 <b>DatingBot User Guide</b>\n\nWelcome! The bot helps you easily discover great connections based on mutual attraction, shared interests, and smart AI matchmaking.\n\n🔍 <b>How Search & Matchmaking Works:</b>\n• <b>Smart Algorithm:</b> matches people based on your AI bio, city, age, dating goals, and shared interests.\n• <b>Search Distance:</b> customize your radius in profile settings — up to 100 km, up to 500 km, nationwide, or worldwide.\n• <b>Endless Search:</b> profiles never run out — once all new profiles are viewed, the search cycles back seamlessly.\n\n⭐ <b>Rating System (1–10):</b>\nRate profiles and get mutual matches.\n• <b>1–5</b> — counts towards the overall average rating.\n• <b>6–10</b> — show interest/like. The user receives a notification with your rating and can rate you back.\n• <b>Mutual Match:</b> when both users rate each other 6+, a <b>«💬 Write»</b> button appears with a direct link to direct messages.\n\n👤 <b>Profile & Settings:</b>\n• In <b>«👤 My Profile»</b> you can update your photos, name, city, interests, goals, search filters, etc. anytime.\n• <b>AI Bio:</b> a private description about yourself — nobody sees it directly, but our AI uses it to find your best matches.\n\n🛡 <b>Safety & Rules:</b>\n• If you encounter spam, fake profiles (someone you know, but it's not them), or harassment, press <b>«🚨 Report»</b> while viewing the profile.\n• Official Channel: @TheBestDating\n• Support: @KimeLowe65",
            [AppLanguage.Hindi] = "📖 <b>DatingBot उपयोगकर्ता गाइड</b>\n\nस्वागत है! बॉट आपको आपसी पसंद, साझा रुचियों और स्मार्ट AI मैचमेकिंग के आधार पर बेहतरीन लोगों से जुड़ने में मदद करता है।\n\n🔍 <b>खोज और मिलान कैसे काम करता है:</b>\n• <b>स्मार्ट एल्गोरिदम:</b> आपके AI विवरण, शहर, आयु, डेटिंग लक्ष्यों और रुचियों के आधार पर लोगों को ढूंढता है।\n• <b>खोज दूरी:</b> प्रोफ़ाइल सेटिंग्स में अपनी दूरी सीमा चुनें — 100 किमी तक, 500 किमी तक, पूरे देश में, या बिना सीमा।\n• <b>निरंतर खोज:</b> प्रोफाइल कभी समाप्त नहीं होतीं — सभी नई प्रोफाइल देखने के बाद खोज दोबारा चक्र में शुरू होती है।\n\n⭐ <b>रेटिंग प्रणाली (1–10):</b>\nउपयोगकर्ताओं को रेट करें और परस्पर पसंद पाएं।\n• <b>1–5</b> — कुल औसत स्कोर में जुड़ता है।\n• <b>6–10</b> — पसंद व्यक्त करें। सामने वाले को आपकी रेटिंग का नोटिफिकेशन मिलेगा और वे आपको वापस रेट कर सकेंगे।\n• <b>परस्पर मैच:</b> यदि दोनों एक-दूसरे को 6+ रेट करते हैं, то सीधे संदेशों में जाने के लिए <b>«💬 लिखें»</b> बटन दिखाई देता है।\n\n👤 <b>आपकी प्रोफ़ाइल और सेटिंग्स:</b>\n• <b>«👤 मेरी प्रोफाइल»</b> में आप कभी भी अपनी फोटो, नाम, शहर, रुचियां, लक्ष्य, खोज फ़िल्टर आदि अपडेट कर सकते हैं।\n• <b>AI बायो:</b> अपने बारे में एक निजी विवरण — इसे कोई नहीं देख सकता, लेकिन हमारा AI सर्वोत्तम मिलान खोजने के लिए इसका उपयोग करता है।\n\n🛡 <b>सुरक्षा और नियम:</b>\n• यदि आपको कोई स्पैम, नकली प्रोफ़ाइल (कोई जिसे आप जानते हैं, लेकिन वह वास्तव में वह नहीं है) या दुर्व्यवहार दिखता है, तो प्रोफ़ाइल देखते समय <b>«🚨 शिकायत करें»</b> दबाएं।\n• आधिकारिक चैनल: @TheBestDating\n• सहायता: @KimeLowe65",
            [AppLanguage.Portuguese] = "📖 <b>Guia do Usuário DatingBot</b>\n\nBem-vindo(a)! O bot ajuda você a encontrar conexões incríveis com base em atração mútua, interesses em comum e recomendações inteligentes de IA.\n\n🔍 <b>Como funcionam a busca e as combinações:</b>\n• <b>Algoritmo Inteligente:</b> combina pessoas com base na sua descrição para IA, cidade, idade, objetivos e interesses.\n• <b>Distância de busca:</b> configure o raio no seu perfil — até 100 km, até 500 km, no mesmo país ou sem restrições.\n• <b>Busca contínua:</b> os perfis não acabam — após ver todos os novos, a busca reinicia em ciclo.\n\n⭐ <b>Sistema de Avaliação (1–10):</b>\nAvalie usuários e ganhe curtidas mútuas.\n• <b>1–5</b> — vai para a média geral de notas.\n• <b>6–10</b> — demonstrar interesse. A pessoa recebe uma notificação com sua nota e pode avaliar você de volta.\n• <b>Match Mútuo:</b> se ambos se avaliarem com 6+, o botão <b>«💬 Conversar»</b> é liberado com link direto para as mensagens privadas.\n\n👤 <b>Seu Perfil e Configurações:</b>\n• Em <b>«👤 Meu Perfil»</b> você pode atualizar fotos, nome, cidade, interesses, objetivos, filtros de busca, etc. a qualquer momento.\n• <b>Bio IA:</b> descrição privada sobre você — ninguém a vê diretamente, mas nossa IA a utiliza para encontrar os melhores pares.\n\n🛡 <b>Segurança e Regras:</b>\n• Se encontrar spam, perfis falsos (alguém que você conhece, mas não é ela) ou ofensas, clique em <b>«🚨 Denunciar»</b> ao visualizar o perfil.\n• Canal Oficial: @TheBestDating\n• Suporte: @KimeLowe65",
            [AppLanguage.Indonesian] = "📖 <b>Panduan Pengguna DatingBot</b>\n\nSelamat datang! Bot ini membantu Anda menemukan kenalan menarik berdasarkan ketertarikan timbal balik, minat yang sama, dan pencocokan cerdas AI.\n\n🔍 <b>Cara Kerja Pencarian & Pencocokan:</b>\n• <b>Algoritma Cerdas:</b> mencocokkan orang berdasarkan deskripsi AI Anda, kota, usia, tujuan kencan, dan kesamaan minat.\n• <b>Jarak Pencarian:</b> atur radius di pengaturan profil — hingga 100 km, hingga 500 km, seluruh negeri, atau tanpa batas.\n• <b>Pencarian Berkelanjutan:</b> profil tidak akan habis — setelah semua profil baru dilihat, pencarian akan mengulang kembali secara siklis.\n\n⭐ <b>Sistem Penilaian (1–10):</b>\nBeri penilaian kepada pengguna dan dapatkan match timbal balik.\n• <b>1–5</b> — masuk ke dalam perhitungan rata-rata skor.\n• <b>6–10</b> — tunjukkan ketertarikan. Pengguna akan menerima notifikasi penilaian Anda dan dapat menilai balik.\n• <b>Match Timbal Balik:</b> jika kedua belah pihak memberi nilai 6+, tombol <b>«💬 Kirim Pesan»</b> akan muncul dengan tautan langsung ke pesan pribadi.\n\n👤 <b>Profil & Pengaturan:</b>\n• Di menu <b>«👤 Profil Saya»</b>, Anda dapat memperbarui foto, nama, kota, minat, tujuan, filter pencarian, dll. kapan saja.\n• <b>Bio AI:</b> deskripsi pribadi tentang diri Anda — tidak ditampilkan ke pengguna lain, tetapi digunakan oleh AI untuk mencari pasangan terbaik.\n\n🛡 <b>Keamanan & Aturan:</b>\n• Jika Anda menemukan spam, profil palsu (orang yang Anda kenal, tetapi bukan dia), atau perilaku tidak pantas, tekan <b>«🚨 Laporkan»</b> saat melihat profil.\n• Saluran Resmi: @TheBestDating\n• Dukungan: @KimeLowe65"
        },
        ["Btn_MainMenu"] = new()
        {
